...
- `summaries/model-memory-rag-stack.md`: deeper notes on model, prompt, context, memory, and RAG.
- `summaries/orchestration-patterns.md`: deeper notes on routing, handoffs, debate, pipelines, and chat rooms.
- `summaries/agent-and-tool-stack.md`: deeper notes on agents, tools, hooks, sessions, A2A, realtime, and MCP.
- `summaries/observe-evaluate-tune.md`: deeper notes on observability, evaluation, OpenJudge, and tuning.
- `summaries/out-of-box-agents-map.md`: deeper notes on the prebuilt agent catalog.
- `summaries/tutorial-map.md`: deeper notes on the research and sales tutorials.
