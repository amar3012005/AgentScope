...
Alice: Hello, I'm Alice, a 50-year-old teacher with a passion for fostering knowledge and guiding young minds.
Bob: Hi, I'm Bob, a 35-year-old engineer who enjoys solving complex problems and designing innovative solutions.
Charlie: Hi, I'm Charlie, a 28-year-old designer who loves creating visually appealing and user-friendly designs.
...
Bob: Alice is a 50-year-old teacher who is passionate about teaching and guiding young minds.
Charlie: Alice is a 50-year-old teacher who is passionate about teaching and guiding her students.
David: I don't have specific information about an Alice you're referring to without more context. Could you provide more details, such as her full name or the field she works in?
...
Stream Printing Messages: Convert the printing messages from an agent into an async generator
...
Code snippet 3: Manually call agents one by one
...
Code snippet 4: Use fanout pipeline
...
The stream_printing_messages function converts the printing messages from agent(s) into an async generator. It will help you to obtain the intermediate messages from the agent(s) in a streaming way.

It accepts a list of agents and a coroutine task, then returns an async generator that yields tuples of (Msg, bool), containing the printing message during execution of the coroutine task.
...
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': 'Hi'}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': 'Hi there! I'}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': "Hi there! I'm Alice,"}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': "Hi there! I'm Alice, a 2"}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': "Hi there! I'm Alice, a 20-year-old student. Nice"}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': "Hi there! I'm Alice, a 20-year-old student. Nice to meet you! How"}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': "Hi there! I'm Alice, a 20-year-old student. Nice to meet you! How can I help you today?"}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': "Hi there! I'm Alice, a 20-year-old student. Nice to meet you! How can I help you today?"}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') False
Msg(id='aztoFDNWYq2gTZBQdyLxEk', name='Alice', content=[{'type': 'text', 'text': "Hi there! I'm Alice, a 20-year-old student. Nice to meet you! How can I help you today?"}], role='assistant', metadata={}, timestamp='2026-04-02 03:53:10.756', invocation_id='471fb1cd-3e09-9633-8584-dc628f29e4f3') True
...
Total running time of the script: (0 minutes 23.813 seconds)