...
from agentscope_blaiq.contracts.workflow import AnalysisMode, ArtifactFamily, SubmitWorkflowRequest, WorkflowMode
...
def test_strategic_agent_routes_finance_analysis_mode():
    request = SubmitWorkflowRequest(
        user_query="Analyze Tesla's Q4 2024 financial performance",
        workflow_mode=WorkflowMode.hybrid,
        analysis_mode=AnalysisMode.finance,
    )
    assert StrategicAgent.classify_artifact_family(request) == ArtifactFamily.finance_analysis
